                            ...
                            <div class="card-body">
                                <div class="media d-flex">
                                    <div class="align-self-top">
                                        <i class="icon-cloud-download text-white font-large-4 float-left"></i>
                                    </div>
                                    <div class="media-body text-white text-right align-self-bottom mt-3">
                                        <span class="d-block mb-1 font-medium-1">Total Downloads</span>
                        ...
                        <div class="card-content">
                            <div class="card-body">
                                <div class="media d-flex">
                                    ...
                                    <div class="media-body text-white text-right align-self-bottom mt-3">
                                        <span class="d-block mb-1 font-medium-1">Active Users</span>
                                        <h1 class="text-white mb-0">0</h1>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="card-body">
                                <div class="media d-flex">
                                    <div class="media-body text-white text-left align-self-bottom mt-3">
                                        ...
                                        <h1 class="text-white mb-0">N/A</h1>
                                    </div>
                                    <div class="align-self-top">
                                        <i class="icon-wallet icon-opacity text-white font-large-4 float-right"></i>
                                    </div>
                                </div>
                            </div>
                        </div>
