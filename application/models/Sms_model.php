...
#[AllowDynamicProperties]
  class Sms_model extends CI_Model {
    ...
    public function send_sms($smsData = array()) {
        ...
        $getData = 'mobiles='.$mobile.'&message='.urlencode($message).'&sender='.$senderId.'&route='.$routeId.'&DLT_TE_ID='.$DLT_TE_ID.'&country='.$country."&response=json";
