                                        ...
                                        <div class="row justify-content-center">
                                            ...
                                            <div class="col-sm-6 col-md-3 col-lg-2">
                                                <div class="form-group mb-0">
                                                    <label for="parent_cat_id">Status</label>
                                                    <select class="form-control input-sm" name="status">
                                                    <?php 
                                                    foreach ($a_status as $key => $value) 
                                                    {
                                                        echo optionStatus($key,$value,1);
                                                    } ?>
                                                    </select>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-sm-6 col-md-3 col-lg-2">
                                                <div class="form-group mb-0">
                                                    <label for="parent_cat_id">State</label>
                                            ...
                                            <div class="col-sm-6 col-md-3 col-lg-2">
                                               <div class="form-group mb-0">
                                                    <label for="sub_cat_id">City</label>
                                            ...
                                            <div class="col-sm-6 col-md-3 col-lg-2">
                                                <div class="form-group mb-0">
                                                    ...
                                                    <input type="date" autocomplete="false" name="appointment_date" id="appointment_date" class="form-control input-sm" placeholder="Appointment date" />
                                                </div>
