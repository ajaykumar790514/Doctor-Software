<div class="card-content collapse show">
    <div class="card-body">
    <form   class="form <?=(!in_array($row->status, [2,3])) ? 'ajaxsubmit' : '' ?> reload-tb" 
            action="<?=(!in_array($row->status, [2,3])) ? $action_url : 'javascript:void(0)'?>" 
            method="POST" 
        ...
        <div class="col-md-12 p-0 mt-1">
            <!-- form -->
                ...
                <div class="form-body w-100">
                    ...
                    <div class="form-group text-center w-100 mb-4" style="position:relative;height: 40px;">
                        <a href="<?=$report_url?><?=$row->patient_code?>" class="btn btn-primary btn-sm" target="_blank">Prescription History</a>

                        <a href="javascript:void(0)"  data-url="<?=$fetch_medicine_url?><?=$row->patient_id?>" data-target=".medicines-tbody" class="btn btn-primary btn-sm ml-1" ajax-load >Fill Prescription From Last Appointment</a>
                    </div>
                    <?php endif; ?>
                    <style type="text/css">
                        .medicines-tb{
                ...
                <div class="form-actions text-right pb-0">
                    ...
                    <button type="submit" class="btn btn-primary mr-1 <?=(in_array($row->status, [2,3])) ? 'disabled' : ''?>" <?=(in_array($row->status, [2,3])) ? 'disabled' : ''?>  >
