                                        ...
                                        <div class="row justify-content-center">
                                            <div class="col-sm-6 col-md-3 col-lg-2">
                                                ...
                                                <!-- <div class="form-group "> -->
                                                    ...
                                                    <select class="form-control input-sm" id="clinic_id" name="clinic_id">
                                                    <?php 
                                            ...
                                            <div class="col-sm-6 col-md-4 col-lg-3">
                                                <div class="form-group mb-0">
                                                    <label for="name">Patient Name / Code / Mobile</label>
                                                    <input autocomplete="false" name="name" id="name" class="form-control input-sm" placeholder="Name" value="<?=@$_POST['name']?>" />
                                                </div>

                                            </div>

                                            <div  class="col-sm-6 col-md-4 col-lg-3 mt-2">
                                           <button type="button"  onclick="button_excel_new()" class="btn btn-sm btn-primary"><i class="fas fa-arrow-down"></i> Export to Excel</button>
                                           </div>
                                            <div class="col-auto">
                                                <div class="form-group">
...
<script>
 function button_excel_new() {
    var clinic_id = $('#clinic_id').val();
    var search = $('#name').val();

    // Make AJAX request
    $.ajax({
        url: '<?=base_url();?>export_to_excel',
        type: 'POST',
        data: { clinic_id: clinic_id, search: search },
        success: function(response, status, xhr) {
            ...
            filename = filename || 'Clinic_Wise_Patient_Report.csv';
...
let formattedDate = `${day}-${monthNames[monthIndex]}-${year}`;
  ...
  let fileName = `patient_report_export_${formattedDate}.xlsx`;
