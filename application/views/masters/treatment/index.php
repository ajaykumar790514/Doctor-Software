                                ...
                                <form autocomplete="off" class="form dynamic-tb-search" action="<?=$tb_url?>" method="POST" enctype="multipart/form-data" tagret-tb="#tb">
                                            ...
                                            <div class="col-md-2">
                                                ...
                                                <div class="form-group mb-0">
                                                    ...
                                                    <input autocomplete="false" name="tb-search" id="tb-search" value="<?php if($search!='null'){echo $search;}?>" class="form-control input-sm" placeholder="Name" />
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-auto">
                                                <div class="form-group">
                                                    ...
                                                    <button type="reset" class="btn btn-danger btn-sm mt-2 mr-1"> Reset</button>
                                                    <!-- <button type="button" class="btn btn-success btn-sm mt-2" id="export-trip"> Export</button> -->
                                                </div>
