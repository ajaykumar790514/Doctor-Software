           ...
           <tbody>
               ...
               <tr >
                    ...
                    <td class="text-center">
                       <img src="<?=img_base_url()?><?=$row->photo?>" class="img-sm zoom-img">
                    </td>
                   ...
                   <td>
                       <a href="javascript:void(0)" data-toggle="modal" data-target="#showModal" data-whatever="Update Medicine - <?=$row->name?>" data-url="<?=$update_url?><?=$row->id?>" title="Update">
