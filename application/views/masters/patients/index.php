                                        ...
                                        <div class="row justify-content-center">
                                            <div class="col-sm-6 col-md-3 col-lg-2">
                                                <div class="form-group mb-0 <?=(@$user->user_role==8) ? 'd-none':''?>">
                                                    ...
                                                    <select class="form-control input-sm" id="clinic" name="clinic_id">
                                                        <?php 
                                            ...
                                            <div class="col-auto">
                                                ...
                                                <a href="javascript:void(0)" data-toggle="modal" data-target="#showModal" data-whatever=" Send SMS" data-url="<?=$sms_url?>" class="btn btn-primary  btn-sm mt-2 mr-1" class="btn btn-primary btn-sm add-btn"> 
                                             <i class="ft-plus"></i> Send SMS
                                             </a>
