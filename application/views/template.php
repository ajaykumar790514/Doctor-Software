    ...
    $(t.attr('tagret-form')).submit();
        ...
        $(document).on('change', '.payment_mode', function(event) {
            ...
            if (payment_mode == 2) {
                ...
                $('.online_amount').addClass('d-none');
                $('.cash_amount').addClass('d-none');
            } else if(payment_mode == 3){
                $('.online_amount').removeClass('d-none');
        ...
        $(document).on('change', '.appointment_type', function(event) {
            ...
            if(appointment_type==1 || appointment_type==2){
                $('.payment_mode_').removeClass('d-none').find('input').prop('required', true);
