       ...
       <table class="table table-bordered base-style" id="mytable">
           <thead>
               <tr>
                   ...
                   <th class="text-center">Video Category</th>
           ...
           <tbody>
               ...
               <tr >
                   ...
                   <td class="text-center">
                       <span class="changeStatus" data-toggle="change-status" value="<?=($row->active==1) ? 0 : 1?>" data="<?=$row->id?>,se_videos,id,active" ><i class="<?=($row->active==1) ? 'la la-check-circle' : 'icon-close'?>" title="Click for chenage status"></i></span>
                   </td>
